...
exports.handleReceivedTransaction = exports.replaceChain = exports.addBlockToChain = exports.isValidNewBlock = exports.isValidBlockStructure = exports.calculateHash = exports.calculateHashForBlock = exports.findMyTx = exports.sendTransaction = exports.getAccountBalance = exports.generatenextBlockWithTransaction = exports.generateNextBlock = exports.getMyUnspentTransactionOutputs = exports.generateRawNextBlock = exports.getLatestBlock = exports.setUnspentTxOuts = exports.getUnspentTxOuts = exports.getBlockchain = exports.getCurrentTimestamp = void 0;
...
var genesisBlock = new _Block["default"](0, '91a73664bc84c0baa1fc75ea6e4aa6d1d20c5df664c724e3159aefc2e1186627', '', 0, [genesisTransaction], 0, 0);
...
var findMyTx = function findMyTx() {
  var txs = [];
  blockchain.forEach(function (block) {
    block.data.filter(function (data) {
      return data.address === wallet.getPublicFromWallet();
    }).forEach(function (data) {
      return txs.push.apply(txs, _toConsumableArray(data.txOuts));
    });
  });
  return txs;
};

exports.findMyTx = findMyTx;
